<?php
    ...
    class PageControllerDecorator extends Extension {
        ...
        public function getCSS() {
            ...
            $files = array(
                $themeFolder . '/css/styles.css?version=' . SiteConfig::current_site_config()->SiteVersion
            );

            if(file_exists(BASE_PATH . '/' . $this->owner->ThemeDir() . '/css/pagetypes/' . $css . '.css')) {
                $files[] = $themeFolder . '/css/pagetypes/' . $css . '.css?version=' . SiteConfig::current_site_config()->SiteVersion;
            }
