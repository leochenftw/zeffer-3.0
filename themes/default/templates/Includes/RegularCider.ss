<div class="column is-8 cider__details">
    <% if $TitleImage %>
    <h3 class="cider__details__heading title is-2">
        $TitleImage.SetWidth(960)
    </h3>
    <% else %>
    <h3 class="title is-3">$Title</h3>
    <% end_if %>
    <% if $Subtitle %><p class="title is-3">$Subtitle</p><% end_if %>
        ...
        <div class="column is-half">
            <div class="with-title">
                ...
                <div class="columns dryness is-marginless is-mobile">
                    <% loop $Crosses('Dryness') %>
                        <div class="column"><div class="cross">$X</div></div>
                    <% end_loop %>
                </div>
            </div>
        </div>
